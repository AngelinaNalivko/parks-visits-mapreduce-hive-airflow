...
with DAG(
    ...
    hadoop_streaming = BashOperator(
        ...
        bash_command=(
            "mapred streaming "
            "-files {{ params.dags_home }}/project_files/mapper.py,{{ params.dags_home }}/project_files/reducer.py,{{ params.dags_home }}/project_files/combiner.py "
            "-input {{ params.input_dir }}/datasource1/*.csv "
